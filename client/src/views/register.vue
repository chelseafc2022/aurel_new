            ...
            <q-card-section class="main1 text-white">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="text-h6 h_titleHead">Regiter (SPP, SPM, SP2D)</div>
                        <div class="text-subtitle2">Laporan Regiter (SPP, SPM, SP2D)</div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        getView: function () {
            ...
            fetch(this.$store.state.url.DATA_REGISTER + "view", {
                method: "POST",
                headers: {
        ...
        addData: function () {
            ...
            fetch(this.$store.state.url.DATA_REGISTER + "addData", {
                method: "POST",
                headers: {
                    authorization: "kikensbatara " + localStorage.token
                },
            ...
            editData: function () {
                ...
                fetch(this.$store.state.url.DATA_REGISTER + "editData", {
                    method: "POST",
                    headers: {
                        authorization: "kikensbatara " + localStorage.token
                    },
            ...
            removeData: function () {
                ...
                fetch(this.$store.state.url.DATA_REGISTER + "hapusData", {
                    method: "POST",
                    headers: {
                        "content-type": "application/json",
                        authorization: "kikensbatara " + localStorage.token
