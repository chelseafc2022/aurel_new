            ...
            <q-card-section class="main1 text-white">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="text-h6 h_titleHead">BKU</div>
                        <div class="text-subtitle2">Buku Kas Umum</div>
                    </div>
        ...
        <q-dialog v-model="mdl_add" persistent>
            <q-card class="mdl-md">
                <q-card-section class="main1">
                    <div class="text-h6 h_modalhead">Tambah Data BKU</div>
                </q-card-section>
        ...
        <q-dialog v-model="mdl_edit" persistent>
            <q-card class="mdl-md">
                <q-card-section class="bg-orange text-white">
                    <div class="text-h6 h_modalhead">Edit Data BKU</div>
                </q-card-section>
...
export default {
    ...
    methods: {
        ...
        getView: function () {
            ...
            fetch(this.$store.state.url.DATA_BKU + "view", {
                method: "POST",
                headers: {
        ...
        addData: function () {
            ...
            fetch(this.$store.state.url.DATA_BKU + "addData", {
                method: "POST",
                headers: {
                    authorization: "kikensbatara " + localStorage.token
                },
            ...
            editData: function () {
                ...
                fetch(this.$store.state.url.DATA_BKU + "editData", {
                    method: "POST",
                    headers: {
                        authorization: "kikensbatara " + localStorage.token
                    },
            ...
            removeData: function () {
                ...
                fetch(this.$store.state.url.DATA_BKU + "hapusData", {
                    method: "POST",
                    headers: {
                        "content-type": "application/json",
                        authorization: "kikensbatara " + localStorage.token
