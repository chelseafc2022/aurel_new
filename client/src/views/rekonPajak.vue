            ...
            <q-card-section class="main1 text-white">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="text-h6 h_titleHead">Rekon Pajak</div>
                        <div class="text-subtitle2">Laporan Rekon Pajak</div>
                    </div>
        ...
        <q-dialog v-model="mdl_add" persistent>
            <q-card class="mdl-md">
                <q-card-section class="main1">
                    <div class="text-h6 h_modalhead">Tambah Data Rekon Pajak</div>
                </q-card-section>
        ...
        <q-dialog v-model="mdl_edit" persistent>
            <q-card class="mdl-md">
                <q-card-section class="bg-orange text-white">
                    <div class="text-h6 h_modalhead">Edit Data Rekon Pajak</div>
                </q-card-section>
...
export default {
    ...
    methods: {
        ...
        getView: function () {
            ...
            fetch(this.$store.state.url.DATA_RP + "view", {
                method: "POST",
                headers: {
        ...
        addData: function () {
            ...
            fetch(this.$store.state.url.DATA_RP + "addData", {
                method: "POST",
                headers: {
                    authorization: "kikensbatara " + localStorage.token
                },
            ...
            editData: function () {
                ...
                fetch(this.$store.state.url.DATA_RP + "editData", {
                    method: "POST",
                    headers: {
                        authorization: "kikensbatara " + localStorage.token
                    },
            ...
            removeData: function () {
                ...
                fetch(this.$store.state.url.DATA_RP + "hapusData", {
                    method: "POST",
                    headers: {
                        "content-type": "application/json",
                        authorization: "kikensbatara " + localStorage.token
