            ...
            <table width="100%">
              ...
              <template v-for="(data, index) in list_data">
                ...
                <template v-for="(data1, index1) in data.sub_kegiatan">
                  ...
                  <!-- RINCIAN -->
                  <template v-for="(rincian, rIndex) in data1.rincian">
                    <tr class="h_table_body bg-white" :key="'rincian-'+rincian.id">
                      ...
                      <td>{{ UMUM.Rupiah(rincian.harga) }}</td>
                      <td>{{ rincian.ppn }}</td>
                      ...
                      <td class="text-center">
                        <q-btn-dropdown
                          round dense
                          icon="pending"
                          :color="UMUM.indikatorNull(rincian.jml_target_keuangan)"
                        >
                          <q-list>
                            <q-item clickable v-close-popup
                              @click="mdl_view_sub_kegiatan_rincian = true; selectRincian(rincian, data1)">
                              <q-item-section>Detile Target Kegiatan</q-item-section>
                            </q-item>

                            <q-item clickable v-close-popup
                              @click="mdl_add_sub_kegiatan_rincian = true; selectRincian(rincian, data1)">
                              <q-item-section>Perbaharui Target Kegiatan</q-item-section>
                            </q-item>
                          </q-list>
                        </q-btn-dropdown>
                      </td>
