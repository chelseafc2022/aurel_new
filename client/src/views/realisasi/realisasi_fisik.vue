            ...
            <table width="100%">
              ...
              <template v-for="(data, index) in list_data">
                ...
                <template v-for="(data1, index1) in data.sub_kegiatan">
                 ...
                 <!-- ================= RINCIAN ================= -->
                 <template v-for="(r, rIndex) in data1.rincian">
                  <tr
                    class="h_table_body bg-white"
                    style="font-size:11px;font-weight:500"
                    :key="r.id + '-rincian-' + rIndex"
                  >
                    <td></td>
                    <td></td>
                    ...
                    <td class="text-center">
                      <q-btn
                        ...
                        size="sm"
                        icon="pending"
                        :color="UMUM.indikatorNull(r.jml_realisasi_fisik)"
                        text-color="white"
                        @click="mdl_view_realisasi = true; selectRincian(r, data1)"
                      />
                    </td>
                  </tr>
                </template>
                    ...
                    <q-card-section class="q-pt-none">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12 frame_cari ">
                              <hr class="hrpagin2">
                              <div>
                                <q-btn class="main1x_1" size="sm" icon="+" label="Tambah Data" @click="openAddRealisasi()" />
                              </div>
                              <hr class="hrpagin2">
                      ...
                      <q-card-section class="q-pt-none">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12 frame_cari frame_cari">
                              ...
                              <select v-model.number="realisasi.kk_jenis" class="bg-white">
                            ...
                            <div class="col-12">
                              <Kk_kontrak
                                v-if="realisasi.kk_jenis == 1"
                                :realisasi="realisasi"
                                :type="1"
                                @refreshz="viewRealisasi()"
                              />


                              <Kk_sppd
                                v-if="realisasi.kk_jenis == 2"
                                :realisasi="realisasi"
                                :type="1"
                                @refreshz="viewRealisasi()"
                              />
...
export default {
  ...
  methods: {
    ...
    openAddRealisasi () {
        ...
        this.$store.dispatch(
          'getRincianKeuanganSerapan',
          this.realisasi.rincian_id
        )

        this.mdl_add_realisasi = true
      },
    ...
    selectRincian(r, sub) {
      this.rincian = { ...r }
      this.realisasi.rincian_id = r.id
      this.target.rincian_id = r.id
